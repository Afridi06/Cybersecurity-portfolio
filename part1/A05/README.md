...
**TLS (Transport Layer Security)** used in **HTTPS**

## Description
TLS is a cryptographic protocol used to secure communication over the internet. It encrypts the data exchanged between a user's browser and a website server.
